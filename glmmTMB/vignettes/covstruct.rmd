...
ctab <- read.delim(sep = "#", comment = "",
 ...
 Separable unstructured member by AR(1) time # `unxar1` # $m + m(m-1)/2 + 1$ # Complete member-by-time coordinate levels; unit-spaced time # member log-SDs; unstructured member correlation; AR(1) time correlation
 Separable homogeneous compound-symmetric member by AR(1) time # `homcsxar1` # $3$ # Complete member-by-time coordinate levels; unit-spaced time # log-SD; homogeneous member correlation; AR(1) time correlation
